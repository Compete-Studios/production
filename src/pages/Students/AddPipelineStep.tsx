...
import { addAStudentPipelineStep, getUploadedStudioImages } from '../../functions/api';
...
export default function AddPipelineStep() {
    ...
    const handleSubmit = () => {
        ...
        addAStudentPipelineStep(data).then((res) => {
            if (res.status === 200) {
        ...
        setTimeout(() => {
            console.log(data);
            setIsLoading(false);
            window.location.href = '/students/pipeline';
        }, 1000);
    };
    ...
    return (
        <>
            <div className="panel max-w-5xl mx-auto mt-4">
                <div>
                    <h1 className="font-semibold text-lg uppercase">Add a Student Pipeline Step</h1>
