    ...
    useEffect(() => {
        setFilteredItems(() => {
            return studios?.filter((item: any) => {
                return item.Studio_Name.toLowerCase().includes(search.toLowerCase()) || item.Contact_Email.toLowerCase().includes(search.toLowerCase()) || item.Contact_Number.toLowerCase().includes(search.toLowerCase());
            });
        });
    }, [search, studios]);
