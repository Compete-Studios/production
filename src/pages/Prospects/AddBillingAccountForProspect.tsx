...
import { addProspectBillingAccount, getProspectById } from '../../functions/api';
...
export default function AddABillingAccountForProspect() {
    ...
    const addAccount = (e: any) => {
        ...
        createNewPaySimpleCustomer(billingInfo).then((res) => {
            ...
            addProspectBillingAccount(billingData).then((res) => {
                navigate(`/prospects/${id}/finish-billing-setup-options`)
            });
        });
    ...
    const autoFill = (e: any) => {
        ...
        setBillingInfo({
            ...billingInfo,
            firstName: prospectInfo?.First_Name,
            lastName: prospectInfo?.Last_Name,
            email: prospectInfo?.email,
            phone: prospectInfo?.Phone,
            streetAddress1: prospectInfo?.mailingaddr,
            streetAddress2: prospectInfo?.mailingaddr2,
            city: prospectInfo?.city,
            stateCode: prospectInfo?.state,
            zipCode: prospectInfo?.Zip,
        });
    };
                    ...
                    <div className="mb-5 flex items-center justify-between">
                        ...
                        <div className="text-right">
                            ...
                            <button className="block btn btn-secondary mt-2 hover:bg-indigo-600" onClick={autoFill}>
                                Click here if its the same as the prospect's info
                            </button>
                        </div>
                    </div>
