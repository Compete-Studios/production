    ...
    return (
        <div>
            <div className="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full">
                <div
                    className={`panel p-4 flex-none w-[340px] max-w-full absolute xl:relative z-10 space-y-4 xl:h-auto h-full xl:block ltr:xl:rounded-r-md ltr:rounded-r-none rtl:xl:rounded-l-md rtl:rounded-l-none hidden ${
                    ...
                    <div className="flex flex-col h-full pb-16">
                        <div className="pb-5">
                            <div className="flex text-center items-center">
                                ...
                                <h3 className="text-lg font-semibold ltr:ml-3 rtl:mr-3">Pipeline Steps</h3>
                            </div>
                        </div>
                            ...
                            <div className="space-y-1">
                                ...
                                >
                                    <div className="flex items-center">
                                        <div className="">Failed Payments</div>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="bg-cs dark:bg-cshover dark:text-zinc-950 rounded-md py-0.5 px-2 font-semibold whitespace-nowrap">
...
export default LatePaymentPipeline;
