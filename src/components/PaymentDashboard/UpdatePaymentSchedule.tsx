...
export default function UpdatePaymentSchedule({ payID }: any) {
    const [open, setOpen] = useState(false);

    return (
        <>
            <Tippy content="Update Schedule">
                <button className="text-success hover:text-green-700" onClick={() => setOpen(true)}>
