...
export default function ViewPayments() {
    const { id, latePayementPipeline, suid } = useParams();
                ...
                <div className="lg:flex lg:items-center">
                    <div className="sm:flex-auto w-full sm:gap-x-4">
                        <h1 className="uppercase font-semibold text-lg dark:text-white">
                            Students in Pipeline Step <span className="font-bold text-primary">{latePayementPipeline?.find((step: any) => step.PaymentPipelineStepId === parseInt(id ?? ''))?.PipelineStepName}</span>
                        </h1>
