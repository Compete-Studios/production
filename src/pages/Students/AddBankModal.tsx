            ...
            <div className="flex items-center justify-center">
                {inStudent ? (
                    <Tippy content="Add Bank Account">
                        <button className="uppercase font-lg font-bold w-full hover:bg-secondary-light p-4 text-left flex items-center gap-4 whitespace-nowrap" onClick={() => setModal(true)}>
