...
export default function ActionItem({ student, pipeline, studioOptions }: any) {
                                    ...
                                    <div className="p-5">
                                        <Tab.Group>
                                            ...
                                            <Tab.Panels>
                                                <Tab.Panel>
                                                    <div>
                                                        <SendMail defaultEMail={pipeline} studioOptions={studioOptions} student={student} setShowActionModal={setShowActionModal}/>
                                                    </div>
                                                </Tab.Panel>
                                                <Tab.Panel>
                                                    <div className="pt-8">
                                                        <SendText defaultText={pipeline} studioOptions={studioOptions} student={student} setShowActionModal={setShowActionModal}/>
                                                    </div>
                                                </Tab.Panel>
                                                <Tab.Panel>
