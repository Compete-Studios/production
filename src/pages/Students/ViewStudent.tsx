                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col justify-center items-center">
                                {/* <img src="/assets/profilepicBlank.webp" alt="img" className="w-24 h-24 rounded-full object-cover  mb-5" /> */}
                                <IconUser className="w-24 h-24 rounded-full object-cover  mb-5" />
                            ...
                            <ul className="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                                ...
                                <li>
                                    <button className="flex items-center gap-2">
                                        ...
                                        <span className="text-primary truncate">{student?.email}</span>
                                    </button>
                                </li>
                                <li className="flex items-center gap-2">
                                    <IconPhone />
