...
import { updateProspectNotes, updateStudentNotes } from '../../functions/api';
import Swal from 'sweetalert2';

export default function AddProspectNotesModal({ student, setStudent, studentID }: any) {
    ...
    const handleAddNoteToTopOfNotes = async (e: any) => {
        ...
        const newNote: any = noteDate + ' ' + initials + ' ' + newNotes + '\n' + student.Notes;
        setStudent({ ...student, Notes: newNote });
        const noteData = {
            prospectId: studentID,
            notes: newNote,
        };
