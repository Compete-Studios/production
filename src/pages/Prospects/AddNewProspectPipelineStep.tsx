...
import { addAProspectPipelineStep, getUploadedStudioImages } from '../../functions/api';
...
export default function AddNewProspectPipelineStep() {
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('Add a Prospect Pipeline Step'));
    });
    const { suid } = UserAuth();
    ...
    const handleSubmit = () => {
        ...
        if (!pipelineStepName) {
            ...
            setTimeout(() => {
                console.log(data);
                setIsLoading(false);
                window.location.href = '/prospects/prospect-pipeline';
            }, 1000);
        }
    };
    ...
    return (
        ...
        <ul className="flex space-x-2 rtl:space-x-reverse">
            ...
            <div className="panel max-w-5xl mx-auto mt-4">
                <div>
                    <h1 className="font-semibold text-lg uppercase">Add a Prospect Pipeline Step</h1>
